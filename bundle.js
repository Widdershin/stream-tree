...
var _diagram = require('./src/diagram');
...
function renderView(count) {
  return (0, _dom.div)('.counter', ['Count:' + count, (0, _dom.button)('.add', 'Add'), (0, _dom.button)('.subtract', 'Subtract'), (0, _dom.button)('.reset', 'Reset'), (0, _dom.pre)('function main (sources) {' + main.toString() + '}'), (0, _dom.pre)('function intent (sources) {' + intent.toString() + '}'), (0, _dom.pre)('function model (sources) {' + model.toString() + '}'), (0, _dom.pre)('function view (sources) {' + view.toString() + '}')]);
}

var add = function add(count) {
  return count + 1;
};
var subtract = function subtract(count) {
  return count - 1;
};
var reset = function reset(count) {
  return 0;
};

var intent = (0, _diagram2.default)(_templateObject);

var model = (0, _diagram2.default)(_templateObject2, { xs: _xstream2.default, add: add, subtract: subtract, reset: reset });

var view = (0, _diagram2.default)(_templateObject3, { renderView: renderView });

var main = (0, _diagram2.default)(_templateObject4, { intent: intent, model: model, view: view });
...
},{"./src/diagram":74,"@cycle/dom":11,"@cycle/xstream-run":69,"xstream":73}],2:[function(require,module,exports){
"use strict";
...
},{"@cycle/xstream-adapter":20,"xstream":73}],5:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"./ElementFinder":2,"./EventDelegator":3,"./fromEvent":8,"./isolate":12,"./utils":19,"@cycle/xstream-adapter":20,"matches-selector":21,"xstream":73}],6:[function(require,module,exports){
"use strict";
...
},{"xstream":73}],9:[function(require,module,exports){
"use strict";
var hyperscript_1 = require('./hyperscript');
...
},{"./MainDOMSource":5,"./VNodeWrapper":7,"./isolateModule":13,"./modules":17,"./transposition":18,"./utils":19,"@cycle/xstream-adapter":20,"snabbdom":66,"xstream":73}],15:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var transposition_1 = require('./transposition');
...
},{"@cycle/xstream-adapter":20,"xstream":73}],17:[function(require,module,exports){
"use strict";
...
},{"@cycle/xstream-adapter":20,"xstream":73}],19:[function(require,module,exports){
"use strict";
...
},{"xstream":73}],21:[function(require,module,exports){
'use strict';
...
},{"dup":20,"xstream":73}],72:[function(require,module,exports){
"use strict";
...
},{"./range":75,"vm":76}],75:[function(require,module,exports){
"use strict";
...
},{"indexof":77}],77:[function(require,module,exports){
